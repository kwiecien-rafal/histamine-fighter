...
- A goal line after the sections says what the user is after, and a count line says how many to suggest; follow both.
...
Write only as many alternatives as the count line asks for, never more. For each, write:
